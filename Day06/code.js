...
for (let i = 0; i < inputArray.length; i++) {
  let orbit = inputArray[i];
  let planet1 = orbit.split(")")[0];
  let planet2 = orbit.split(")")[1];

  if (planetOrbitMap.has(planet1)) {
    if (planetOrbitMap.get(planet2) == undefined) {
  ...
  if (planet1 == "COM" && !planetOrbitMap.has(planet1)) {
    planetOrbitMap.set(planet1, 0);
