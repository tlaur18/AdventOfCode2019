...
while (programCounter < inputArray.length) {
    ...
    parameter1 = immediateOne ? inputArray[programCounter + 1] : inputArray[inputArray[programCounter + 1]]
    parameter2 = immediateTwo ? inputArray[programCounter + 2] : inputArray[inputArray[programCounter + 2]]
    resultAddress = inputArray[programCounter + 3]   //Er ikke helt sikker på hvordan den her lige fungerer

    if (opCode == 1) {
        inputArray[resultAddress] = parameter1 + parameter2
        programCounter += 4
        continue;
    } else if (opCode == 2) {
        inputArray[resultAddress] = parameter1 * parameter2
        ...
        valueToSave = 1;          //TODO: Make it read user input
        saveAddress = inputArray[programCounter + 1]
        inputArray[saveAddress] = valueToSave
        programCounter += 2
    } else if (opCode == 4) {
        console.log("ProgramCounter: " + programCounter + " - " + parameter1)
        programCounter += 2
    } else {
        console.log("Invalid OpCode: " + opCode + "\tProgramCounter:" + programCounter + "\tInstruction: " + inputArray[programCounter])
        break
    }
}
